...
Working with Big Data was also part of the job so I started to develop a bunch of Shiny apps (e.g. [REFINE](https://fricour.shinyapps.io/CARBON_REFINE/),  [CARBON](https://fricour.shinyapps.io/carbon_fluxes_app/) and [APPERO](https://fricour.shinyapps.io/Appero/)) to better visualize and try to better understand the carbon dynamics of the ocean at local and global scales.<br><br>
